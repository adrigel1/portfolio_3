const ACTIVE_SLIDE_CLASSNAME = 'slider__slide_active';

const slidesNodes = Array.from(document.querySelectorAll('.slider__slide'));
console.log(slidesNodes);
const prevButtonNode = document.querySelector('.slider__control-prev');
const nextButtonNode = document.querySelector('.slider__control-next');
let activeId;
